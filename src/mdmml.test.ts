...
describe("toEvents", () => {
    const cases = [
        { name: "default", mml: "", ch: 0, want: new Uint8Array() },
        {
            name: "note", mml: "cdefgab", ch: 0, want: new Uint8Array([
        ...
        {
            name: "note+-", mml: "dd+d#d-", ch: 0, want: new Uint8Array([
                0x0, 0x90, 0x3e, 0x64, 0x83, 0x60, 0x80, 0x3e, 0x0,
        ...
        {
            name: "len", mml: "l4ee8e.e8^8.", ch: 0, want: new Uint8Array([
        ...
        {
            name: "chode", mml: "{c+e-g#>c<}4.^8.", ch: 0, want: new Uint8Array([
                0x0, 0x90, 0x3d, 0x64,
                0x0, 0x90, 0x3f, 0x64,
                0x0, 0x90, 0x44, 0x64,
                0x0, 0x90, 0x48, 0x64,
        ...
        {
            name: "oct", mml: "o4co5c<c>c", ch: 0, want: new Uint8Array([
                0x0, 0x90, 0x3c, 0x64, 0x83, 0x60, 0x80, 0x3c, 0x0,
        ...
        {
            name: "program", mml: "@0@1@128@129", ch: 0, want: new Uint8Array([
        ...
        {
            name: "pan", mml: "p0p63p127p128", ch: 0, want: new Uint8Array([
                0x0, 0xb0, 0xa, 0,
                0x0, 0xb0, 0xa, 63,
                0x0, 0xb0, 0xa, 127,
                0x0, 0xb0, 0xa, 127,
        ...
        {
            name: "tempo", mml: "t0t120t250", ch: 0, want: new Uint8Array([
        ...
        {
            name: "vel", mml: "v0cv1cv127cv128c", ch: 0, want: new Uint8Array([
        ...
        {
            name: "ch", mml: "$0c$1c$15c$16c", ch: 0, want: new Uint8Array([
                0x0, 0x90, 0x3c, 0x64, 0x83, 0x60, 0x80, 0x3c, 0x0,
                0x0, 0x90, 0x3c, 0x64, 0x83, 0x60, 0x80, 0x3c, 0x0,
    ...
    for (const { name, mml, ch, want } of cases) {
        test(name, () => {
            expect(mdmml.toEvents(mml, ch, 960)).toStrictEqual(want)
        })
    }
})
...
describe("programChange", () => {
    const cases = [
        {
            name: "default", ch: 0, p: 0,
            want: new Uint8Array([0x0, 0xb0, 0x0, 0x0, 0x0, 0xb0, 0x20, 0x0, 0x0, 0xc0, 0xff])
        },
    ]
